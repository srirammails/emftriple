...
public class EmployeePackageImpl extends EPackageImpl implements EmployeePackage {
	 ...
	 * @generated
	 */
	public EAttribute getEmployee_Version() {
	 ...
	 * @generated
	 */
	public EReference getEmployee_Degrees() {
	...
	public EReference getEmployee_EmailAddresses() {
		return (EReference)employeeEClass.getEStructuralFeatures().get(14);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(employeeEClass, EMPLOYEE__VERSION);
		...
		createEReference(employeeEClass, EMPLOYEE__DEGREES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEmployee_Version(), ecorePackage.getELong(), "version", null, 0, 1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEmployee_Degrees(), this.getDegree(), null, "degrees", null, 0, -1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEtriple_1Annotations() {
		...
		addAnnotation
		  (getDegree_Name(), 
		   source, 
		   new String[] {
			 "base", "http://www.example.com/degrees/"
		   });		
		addAnnotation
		  (getAddress_Id(), 
		   source, 
