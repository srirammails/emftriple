...
public class MQueryParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.emftriple.query.ui.contentassist.antlr.internal.InternalMQueryParser createParser() {
		com.emftriple.query.ui.contentassist.antlr.internal.InternalMQueryParser result = new com.emftriple.query.ui.contentassist.antlr.internal.InternalMQueryParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMQueryAccess().getAlternatives(), "rule__MQuery__Alternatives");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.emftriple.query.ui.contentassist.antlr.internal.InternalMQueryParser typedParser = (com.emftriple.query.ui.contentassist.antlr.internal.InternalMQueryParser) parser;
