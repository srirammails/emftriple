 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.DeleteClauseImpl#getFromClause <em>From Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeleteClauseImpl extends MinimalEObjectImpl.Container implements DeleteClause
{
  ...
  {
    return MqlPackage.Literals.DELETE_CLAUSE;
  }
  ...
  public NotificationChain basicSetFromClause(FromClause newFromClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.DELETE_CLAUSE__FROM_CLAUSE, oldFromClause, newFromClause);
  ...
  public void setFromClause(FromClause newFromClause)
  {
    if (newFromClause != fromClause)
    {
      ...
      if (fromClause != null)
        msgs = ((InternalEObject)fromClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.DELETE_CLAUSE__FROM_CLAUSE, null, msgs);
      if (newFromClause != null)
        msgs = ((InternalEObject)newFromClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.DELETE_CLAUSE__FROM_CLAUSE, null, msgs);
      msgs = basicSetFromClause(newFromClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.DELETE_CLAUSE__FROM_CLAUSE, newFromClause, newFromClause));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.DELETE_CLAUSE__FROM_CLAUSE:
