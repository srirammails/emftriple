 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.OrderClause#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link com.emftriple.query.mql.OrderClause#isIsAsc <em>Is Asc</em>}</li>
 *   <li>{@link com.emftriple.query.mql.OrderClause#isIsDesc <em>Is Desc</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.emftriple.query.mql.MqlPackage#getOrderClause()
 * @model
 * @generated
 */
public interface OrderClause extends EObject
{
   ...
   * The list contents are of type {@link com.emftriple.query.mql.OrderItem}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see com.emftriple.query.mql.MqlPackage#getOrderClause_Ordering()
   ...
   * @see com.emftriple.query.mql.MqlPackage#getOrderClause_IsAsc()
   * @model
   * @generated
   */
  boolean isIsAsc();
  ...
  /**
   * Sets the value of the '{@link com.emftriple.query.mql.OrderClause#isIsAsc <em>Is Asc</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.emftriple.query.mql.MqlPackage#getOrderClause_IsDesc()
   * @model
   * @generated
   */
  boolean isIsDesc();
  ...
  /**
   * Sets the value of the '{@link com.emftriple.query.mql.OrderClause#isIsDesc <em>Is Desc</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
