 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.InSeqExpressionImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InSeqExpressionImpl extends InExpressionImpl implements InSeqExpression
{
  ...
  {
    return MqlPackage.Literals.IN_SEQ_EXPRESSION;
  }
  ...
  public EList<Variable> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<Variable>(Variable.class, this, MqlPackage.IN_SEQ_EXPRESSION__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.IN_SEQ_EXPRESSION__ITEMS:
