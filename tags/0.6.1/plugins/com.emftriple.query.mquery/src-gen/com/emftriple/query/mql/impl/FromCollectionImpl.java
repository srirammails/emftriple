 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.FromCollectionImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromCollectionImpl extends FromEntryImpl implements FromCollection
{
  ...
  {
    return MqlPackage.Literals.FROM_COLLECTION;
  }
  ...
  public NotificationChain basicSetPath(AliasAttributeExpression newPath, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_COLLECTION__PATH, oldPath, newPath);
  ...
  public void setPath(AliasAttributeExpression newPath)
  {
    if (newPath != path)
    {
      ...
      if (path != null)
        msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_COLLECTION__PATH, null, msgs);
      if (newPath != null)
        msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_COLLECTION__PATH, null, msgs);
      msgs = basicSetPath(newPath, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_COLLECTION__PATH, newPath, newPath));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_COLLECTION__PATH:
