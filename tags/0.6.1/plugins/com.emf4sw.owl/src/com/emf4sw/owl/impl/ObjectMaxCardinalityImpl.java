 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.ObjectMaxCardinalityImpl#getOnProperty <em>On Property</em>}</li>
...
public class ObjectMaxCardinalityImpl extends ObjectPropertyRestrictionImpl implements ObjectMaxCardinality {
	...
	public NotificationChain basicSetOnProperty(ObjectPropertyExpression newOnProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_MAX_CARDINALITY__ON_PROPERTY, oldOnProperty, newOnProperty);
	...
	public void setOnProperty(ObjectPropertyExpression newOnProperty) {
		if (newOnProperty != onProperty) {
			...
			if (onProperty != null)
				msgs = ((InternalEObject)onProperty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.OBJECT_MAX_CARDINALITY__ON_PROPERTY, null, msgs);
			if (newOnProperty != null)
				msgs = ((InternalEObject)newOnProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.OBJECT_MAX_CARDINALITY__ON_PROPERTY, null, msgs);
			msgs = basicSetOnProperty(newOnProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_MAX_CARDINALITY__ON_PROPERTY, newOnProperty, newOnProperty));
	}
	...
	public NotificationChain basicSetOnClass(ClassExpression newOnClass, NotificationChain msgs) {
		...
		onClass = newOnClass;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, oldOnClass, newOnClass);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnClass(ClassExpression newOnClass) {
		if (newOnClass != onClass) {
			NotificationChain msgs = null;
			if (onClass != null)
				msgs = ((InternalEObject)onClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, null, msgs);
			if (newOnClass != null)
				msgs = ((InternalEObject)newOnClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, null, msgs);
			msgs = basicSetOnClass(newOnClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, newOnClass, newOnClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.OBJECT_MAX_CARDINALITY__ON_PROPERTY:
