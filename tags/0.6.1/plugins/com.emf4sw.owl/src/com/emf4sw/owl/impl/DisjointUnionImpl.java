 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.DisjointUnionImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.DisjointUnionImpl#getDisjointClasses <em>Disjoint Classes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DisjointUnionImpl extends ClassExpressionAxiomImpl implements DisjointUnion {
	/**
	...
	public NotificationChain basicSetExpression(ClassExpression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.DISJOINT_UNION__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(ClassExpression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DISJOINT_UNION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DISJOINT_UNION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DISJOINT_UNION__EXPRESSION, newExpression, newExpression));
	}
	...
	public EList<ClassExpression> getDisjointClasses() {
		if (disjointClasses == null) {
			disjointClasses = new EObjectContainmentEList<ClassExpression>(ClassExpression.class, this, OWLPackage.DISJOINT_UNION__DISJOINT_CLASSES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.DISJOINT_UNION__EXPRESSION:
				return basicSetExpression(null, msgs);
			case OWLPackage.DISJOINT_UNION__DISJOINT_CLASSES:
