...
import static com.emf4sw.owl.atl.OWLTransformations.ecore2owl;
...
public class Ecore2OWLResource implements Transformation<Resource, Resource> {
    ...
    public <K, V> Ecore2OWLResource(Map<String, Object> options) {
    	this.properties = Properties.createProperties(options);
    	this.format = OWLFormats.OWL;
    }
    
    public <K, V> Ecore2OWLResource(OWLFormats format, Map<String, Object> options) {
    	this.properties = Properties.createProperties(options);
    	this.format = format;
    }
