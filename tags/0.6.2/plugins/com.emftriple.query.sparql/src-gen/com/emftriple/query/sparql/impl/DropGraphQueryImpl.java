...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Drop Graph Query</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.emftriple.query.sparql.impl.DropGraphQueryImpl#getIsSilent <em>Is Silent</em>}</li>
 *   <li>{@link com.emftriple.query.sparql.impl.DropGraphQueryImpl#getGraph <em>Graph</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DropGraphQueryImpl extends UpdateOperationImpl implements DropGraphQuery
{
  /**
  ...
  {
    return SparqlPackage.Literals.DROP_GRAPH_QUERY;
  }
  ...
  public void setIsSilent(String newIsSilent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlPackage.DROP_GRAPH_QUERY__IS_SILENT, oldIsSilent, isSilent));
  }
  ...
  public void setGraph(String newGraph)
  {
    ...
    graph = newGraph;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlPackage.DROP_GRAPH_QUERY__GRAPH, oldGraph, graph));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SparqlPackage.DROP_GRAPH_QUERY__IS_SILENT:
        return getIsSilent();
      case SparqlPackage.DROP_GRAPH_QUERY__GRAPH:
        return getGraph();
    }
