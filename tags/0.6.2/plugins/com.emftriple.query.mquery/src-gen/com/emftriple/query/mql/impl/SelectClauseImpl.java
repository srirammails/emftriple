 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.SelectClauseImpl#isIsDistinct <em>Is Distinct</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.SelectClauseImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectClauseImpl extends MinimalEObjectImpl.Container implements SelectClause
{
  ...
  {
    return MqlPackage.Literals.SELECT_CLAUSE;
  }
  ...
  public void setIsDistinct(boolean newIsDistinct)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_CLAUSE__IS_DISTINCT, oldIsDistinct, isDistinct));
  }
  ...
  public EList<SelectExpression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<SelectExpression>(SelectExpression.class, this, MqlPackage.SELECT_CLAUSE__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.SELECT_CLAUSE__EXPRESSIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.SELECT_CLAUSE__IS_DISTINCT:
        return isIsDistinct();
      case MqlPackage.SELECT_CLAUSE__EXPRESSIONS:
