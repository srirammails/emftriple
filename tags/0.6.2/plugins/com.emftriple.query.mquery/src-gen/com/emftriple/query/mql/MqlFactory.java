 ...
 * @generated
 */
public interface MqlFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  MqlFactory eINSTANCE = com.emftriple.query.mql.impl.MqlFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>MQuery</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>MQuery</em>'.
   * @generated
   */
  MQuery createMQuery();
