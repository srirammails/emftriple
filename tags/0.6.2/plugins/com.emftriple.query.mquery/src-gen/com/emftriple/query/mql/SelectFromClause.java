 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.SelectFromClause#getSelectClause <em>Select Clause</em>}</li>
 *   <li>{@link com.emftriple.query.mql.SelectFromClause#getFromClause <em>From Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.emftriple.query.mql.MqlPackage#getSelectFromClause()
 * @model
 * @generated
 */
public interface SelectFromClause extends EObject
{
   ...
   * @see com.emftriple.query.mql.MqlPackage#getSelectFromClause_SelectClause()
  ...
  /**
   * Sets the value of the '{@link com.emftriple.query.mql.SelectFromClause#getSelectClause <em>Select Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.emftriple.query.mql.MqlPackage#getSelectFromClause_FromClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.emftriple.query.mql.SelectFromClause#getFromClause <em>From Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
