 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.LeftJoinImpl#isIsOuter <em>Is Outer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LeftJoinImpl extends FromJoinImpl implements LeftJoin
{
  ...
  {
    return MqlPackage.Literals.LEFT_JOIN;
  }
  ...
  public void setIsOuter(boolean newIsOuter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.LEFT_JOIN__IS_OUTER, oldIsOuter, isOuter));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.LEFT_JOIN__IS_OUTER:
        return isIsOuter();
    }
