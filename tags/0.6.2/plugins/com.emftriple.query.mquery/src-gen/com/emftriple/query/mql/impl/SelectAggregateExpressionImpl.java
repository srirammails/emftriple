 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.SelectAggregateExpressionImpl#isIsDistinct <em>Is Distinct</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.SelectAggregateExpressionImpl#getItem <em>Item</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectAggregateExpressionImpl extends SelectExpressionImpl implements SelectAggregateExpression
{
  ...
  {
    return MqlPackage.Literals.SELECT_AGGREGATE_EXPRESSION;
  }
  ...
  public void setIsDistinct(boolean newIsDistinct)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_AGGREGATE_EXPRESSION__IS_DISTINCT, oldIsDistinct, isDistinct));
  }
  ...
  public NotificationChain basicSetItem(AliasAttributeExpression newItem, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM, oldItem, newItem);
  ...
  public void setItem(AliasAttributeExpression newItem)
  {
    if (newItem != item)
    {
      ...
      if (item != null)
        msgs = ((InternalEObject)item).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM, null, msgs);
      if (newItem != null)
        msgs = ((InternalEObject)newItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM, null, msgs);
      msgs = basicSetItem(newItem, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM, newItem, newItem));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.SELECT_AGGREGATE_EXPRESSION__IS_DISTINCT:
        return isIsDistinct();
      case MqlPackage.SELECT_AGGREGATE_EXPRESSION__ITEM:
        return getItem();
    }
