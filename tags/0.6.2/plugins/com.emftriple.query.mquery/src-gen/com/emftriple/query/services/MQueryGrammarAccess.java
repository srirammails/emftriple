...
@Singleton
public class MQueryGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class QueryModuleElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDefaultQueryMQueryParserRuleCall_1_0 = (RuleCall)cDefaultQueryAssignment_1.eContents().get(0);
		...
		//MQuery
		public RuleCall getDefaultQueryMQueryParserRuleCall_1_0() { return cDefaultQueryMQueryParserRuleCall_1_0; }
	...
	public class NamedQueryElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cQueryMQueryParserRuleCall_2_0 = (RuleCall)cQueryAssignment_2.eContents().get(0);
		...
		//MQuery
		public RuleCall getQueryMQueryParserRuleCall_2_0() { return cQueryMQueryParserRuleCall_2_0; }
	}

	public class MQueryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MQuery");
	...
	public class StringFunctionNameElements extends AbstractParserRuleElementFinder {
		...
		//StringFunctionName returns ecore::EString:
	...
	public class NumericFunctionNameElements extends AbstractParserRuleElementFinder {
		...
		//NumericFunctionName returns ecore::EString:
		//	"ABS" | "SQRT" | "MOD" | "SIZE";
		public ParserRule getRule() { return rule; }
	...
	public class DateTimeFunctionNameElements extends AbstractParserRuleElementFinder {
		...
		//DateTimeFunctionName returns ecore::EString:
	...
	public class DateTimeExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cValueLiteralTemporalTerminalRuleCall_0 = (RuleCall)cValueAssignment.eContents().get(0);
		...
		//LiteralTemporal
		public RuleCall getValueLiteralTemporalTerminalRuleCall_0() { return cValueLiteralTemporalTerminalRuleCall_0; }
	}
	...
	private MQueryElements pMQuery;
	...
	private TerminalRule tLiteralTemporal;
	...
	@Inject
	public MQueryGrammarAccess(GrammarProvider grammarProvider,
	...
	//MQuery:
	//	SelectStatement | UpdateStatement | DeleteStatement;
	public MQueryElements getMQueryAccess() {
		return (pMQuery != null) ? pMQuery : (pMQuery = new MQueryElements());
	}
	
	public ParserRule getMQueryRule() {
		return getMQueryAccess().getRule();
	}
	...
	//terminal LiteralTemporal:
	//	DATE_LITERAL | TIME_LITERAL | TIMESTAMP_LITERAL;
	public TerminalRule getLiteralTemporalRule() {
		return (tLiteralTemporal != null) ? tLiteralTemporal : (tLiteralTemporal = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "LiteralTemporal"));
	} 
