 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.FromClassImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.FromClassImpl#getJoins <em>Joins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromClassImpl extends FromEntryImpl implements FromClass
{
  ...
  {
    return MqlPackage.Literals.FROM_CLASS;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_CLASS__TYPE, oldType, type));
  }
  ...
  public EList<FromJoin> getJoins()
  {
    if (joins == null)
    {
      joins = new EObjectContainmentEList<FromJoin>(FromJoin.class, this, MqlPackage.FROM_CLASS__JOINS);
    }
    return joins;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_CLASS__JOINS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_CLASS__TYPE:
        return getType();
      case MqlPackage.FROM_CLASS__JOINS:
        return getJoins();
    }
