 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.SelectFromClauseImpl#getSelectClause <em>Select Clause</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.SelectFromClauseImpl#getFromClause <em>From Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectFromClauseImpl extends MinimalEObjectImpl.Container implements SelectFromClause
{
  ...
  {
    return MqlPackage.Literals.SELECT_FROM_CLAUSE;
  }
  ...
  public NotificationChain basicSetSelectClause(SelectClause newSelectClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_FROM_CLAUSE__SELECT_CLAUSE, oldSelectClause, newSelectClause);
  ...
  public void setSelectClause(SelectClause newSelectClause)
  {
    if (newSelectClause != selectClause)
    {
      ...
      if (selectClause != null)
        msgs = ((InternalEObject)selectClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_FROM_CLAUSE__SELECT_CLAUSE, null, msgs);
      if (newSelectClause != null)
        msgs = ((InternalEObject)newSelectClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_FROM_CLAUSE__SELECT_CLAUSE, null, msgs);
      msgs = basicSetSelectClause(newSelectClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_FROM_CLAUSE__SELECT_CLAUSE, newSelectClause, newSelectClause));
  }
  ...
  public NotificationChain basicSetFromClause(FromClause newFromClause, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_FROM_CLAUSE__FROM_CLAUSE, oldFromClause, newFromClause);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFromClause(FromClause newFromClause)
  {
    if (newFromClause != fromClause)
    {
      NotificationChain msgs = null;
      if (fromClause != null)
        msgs = ((InternalEObject)fromClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_FROM_CLAUSE__FROM_CLAUSE, null, msgs);
      if (newFromClause != null)
        msgs = ((InternalEObject)newFromClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.SELECT_FROM_CLAUSE__FROM_CLAUSE, null, msgs);
      msgs = basicSetFromClause(newFromClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.SELECT_FROM_CLAUSE__FROM_CLAUSE, newFromClause, newFromClause));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.SELECT_FROM_CLAUSE__SELECT_CLAUSE:
        return basicSetSelectClause(null, msgs);
      case MqlPackage.SELECT_FROM_CLAUSE__FROM_CLAUSE:
