 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.UpdateStatementImpl#getUpdateClause <em>Update Clause</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.UpdateStatementImpl#getSetClause <em>Set Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UpdateStatementImpl extends MQueryImpl implements UpdateStatement
{
  /**
  ...
  {
    return MqlPackage.Literals.UPDATE_STATEMENT;
  }
  ...
  public NotificationChain basicSetUpdateClause(UpdateClause newUpdateClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.UPDATE_STATEMENT__UPDATE_CLAUSE, oldUpdateClause, newUpdateClause);
  ...
  public void setUpdateClause(UpdateClause newUpdateClause)
  {
    if (newUpdateClause != updateClause)
    {
      ...
      if (updateClause != null)
        msgs = ((InternalEObject)updateClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.UPDATE_STATEMENT__UPDATE_CLAUSE, null, msgs);
      if (newUpdateClause != null)
        msgs = ((InternalEObject)newUpdateClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.UPDATE_STATEMENT__UPDATE_CLAUSE, null, msgs);
      msgs = basicSetUpdateClause(newUpdateClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.UPDATE_STATEMENT__UPDATE_CLAUSE, newUpdateClause, newUpdateClause));
  }
  ...
  public NotificationChain basicSetSetClause(SetClause newSetClause, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.UPDATE_STATEMENT__SET_CLAUSE, oldSetClause, newSetClause);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSetClause(SetClause newSetClause)
  {
    if (newSetClause != setClause)
    {
      NotificationChain msgs = null;
      if (setClause != null)
        msgs = ((InternalEObject)setClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.UPDATE_STATEMENT__SET_CLAUSE, null, msgs);
      if (newSetClause != null)
        msgs = ((InternalEObject)newSetClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.UPDATE_STATEMENT__SET_CLAUSE, null, msgs);
      msgs = basicSetSetClause(newSetClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.UPDATE_STATEMENT__SET_CLAUSE, newSetClause, newSetClause));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.UPDATE_STATEMENT__UPDATE_CLAUSE:
        return basicSetUpdateClause(null, msgs);
      case MqlPackage.UPDATE_STATEMENT__SET_CLAUSE:
