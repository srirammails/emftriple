 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.AllExpressionImpl#getQuery <em>Query</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AllExpressionImpl extends ExpressionImpl implements AllExpression
{
  ...
  {
    return MqlPackage.Literals.ALL_EXPRESSION;
  }
  ...
  public NotificationChain basicSetQuery(SelectStatement newQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.ALL_EXPRESSION__QUERY, oldQuery, newQuery);
  ...
  public void setQuery(SelectStatement newQuery)
  {
    if (newQuery != query)
    {
      ...
      if (query != null)
        msgs = ((InternalEObject)query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.ALL_EXPRESSION__QUERY, null, msgs);
      if (newQuery != null)
        msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.ALL_EXPRESSION__QUERY, null, msgs);
      msgs = basicSetQuery(newQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.ALL_EXPRESSION__QUERY, newQuery, newQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.ALL_EXPRESSION__QUERY:
