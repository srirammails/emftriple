 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.HavingClauseImpl#getHaving <em>Having</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HavingClauseImpl extends MinimalEObjectImpl.Container implements HavingClause
{
  ...
  {
    return MqlPackage.Literals.HAVING_CLAUSE;
  }
  ...
  public NotificationChain basicSetHaving(Expression newHaving, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.HAVING_CLAUSE__HAVING, oldHaving, newHaving);
  ...
  public void setHaving(Expression newHaving)
  {
    if (newHaving != having)
    {
      ...
      if (having != null)
        msgs = ((InternalEObject)having).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.HAVING_CLAUSE__HAVING, null, msgs);
      if (newHaving != null)
        msgs = ((InternalEObject)newHaving).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.HAVING_CLAUSE__HAVING, null, msgs);
      msgs = basicSetHaving(newHaving, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.HAVING_CLAUSE__HAVING, newHaving, newHaving));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.HAVING_CLAUSE__HAVING:
