 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.LeftJoin#isIsOuter <em>Is Outer</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.emftriple.query.mql.MqlPackage#getLeftJoin()
 * @model
 * @generated
 */
public interface LeftJoin extends FromJoin
{
   ...
   * @see com.emftriple.query.mql.MqlPackage#getLeftJoin_IsOuter()
   * @model
   * @generated
   */
  boolean isIsOuter();
  ...
  /**
   * Sets the value of the '{@link com.emftriple.query.mql.LeftJoin#isIsOuter <em>Is Outer</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
