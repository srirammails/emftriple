...
public class OTMSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OTMPackage.NAMED_QUERY_TYPE: {
				NamedQueryType namedQueryType = (NamedQueryType)theEObject;
				T result = caseNamedQueryType(namedQueryType);
				if (result == null) result = caseQueryType(namedQueryType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OTMPackage.NAMED_NATIVE_QUERY_TYPE: {
				NamedNativeQueryType namedNativeQueryType = (NamedNativeQueryType)theEObject;
				T result = caseNamedNativeQueryType(namedNativeQueryType);
				if (result == null) result = caseQueryType(namedNativeQueryType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Named Query Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Named Query Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNamedQueryType(NamedQueryType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Named Native Query Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Named Native Query Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNamedNativeQueryType(NamedNativeQueryType object) {
		return null;
	}
