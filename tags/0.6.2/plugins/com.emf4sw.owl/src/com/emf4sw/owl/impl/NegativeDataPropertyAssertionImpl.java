 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.NegativeDataPropertyAssertionImpl#getDataProperty <em>Data Property</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.NegativeDataPropertyAssertionImpl#getSourceIndividual <em>Source Individual</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.NegativeDataPropertyAssertionImpl#getTargetValue <em>Target Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NegativeDataPropertyAssertionImpl extends AssertionImpl implements NegativeDataPropertyAssertion {
	...
	public NotificationChain basicSetDataProperty(DataPropertyExpression newDataProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__DATA_PROPERTY, oldDataProperty, newDataProperty);
	...
	public void setDataProperty(DataPropertyExpression newDataProperty) {
		if (newDataProperty != dataProperty) {
			...
			if (dataProperty != null)
				msgs = ((InternalEObject)dataProperty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__DATA_PROPERTY, null, msgs);
			if (newDataProperty != null)
				msgs = ((InternalEObject)newDataProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__DATA_PROPERTY, null, msgs);
			msgs = basicSetDataProperty(newDataProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__DATA_PROPERTY, newDataProperty, newDataProperty));
	}
	...
	public NotificationChain basicSetSourceIndividual(Individual newSourceIndividual, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__SOURCE_INDIVIDUAL, oldSourceIndividual, newSourceIndividual);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceIndividual(Individual newSourceIndividual) {
		if (newSourceIndividual != sourceIndividual) {
			...
			if (sourceIndividual != null)
				msgs = ((InternalEObject)sourceIndividual).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__SOURCE_INDIVIDUAL, null, msgs);
			if (newSourceIndividual != null)
				msgs = ((InternalEObject)newSourceIndividual).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__SOURCE_INDIVIDUAL, null, msgs);
			msgs = basicSetSourceIndividual(newSourceIndividual, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__SOURCE_INDIVIDUAL, newSourceIndividual, newSourceIndividual));
	}
	...
	public NotificationChain basicSetTargetValue(Literal newTargetValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__TARGET_VALUE, oldTargetValue, newTargetValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetValue(Literal newTargetValue) {
		if (newTargetValue != targetValue) {
			NotificationChain msgs = null;
			if (targetValue != null)
				msgs = ((InternalEObject)targetValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__TARGET_VALUE, null, msgs);
			if (newTargetValue != null)
				msgs = ((InternalEObject)newTargetValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__TARGET_VALUE, null, msgs);
			msgs = basicSetTargetValue(newTargetValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.NEGATIVE_DATA_PROPERTY_ASSERTION__TARGET_VALUE, newTargetValue, newTargetValue));
	}
