 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.DataExactCardinalityImpl#getOnProperty <em>On Property</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.DataExactCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.DataExactCardinalityImpl#getOnDataRange <em>On Data Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataExactCardinalityImpl extends DataPropertyRestrictionImpl implements DataExactCardinality {
	...
	public NotificationChain basicSetOnProperty(DataPropertyExpression newOnProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_EXACT_CARDINALITY__ON_PROPERTY, oldOnProperty, newOnProperty);
	...
	public void setOnProperty(DataPropertyExpression newOnProperty) {
		if (newOnProperty != onProperty) {
			...
			if (onProperty != null)
				msgs = ((InternalEObject)onProperty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DATA_EXACT_CARDINALITY__ON_PROPERTY, null, msgs);
			if (newOnProperty != null)
				msgs = ((InternalEObject)newOnProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DATA_EXACT_CARDINALITY__ON_PROPERTY, null, msgs);
			msgs = basicSetOnProperty(newOnProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_EXACT_CARDINALITY__ON_PROPERTY, newOnProperty, newOnProperty));
	}
	...
	public NotificationChain basicSetOnDataRange(DataRange newOnDataRange, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_EXACT_CARDINALITY__ON_DATA_RANGE, oldOnDataRange, newOnDataRange);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnDataRange(DataRange newOnDataRange) {
		if (newOnDataRange != onDataRange) {
			NotificationChain msgs = null;
			if (onDataRange != null)
				msgs = ((InternalEObject)onDataRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DATA_EXACT_CARDINALITY__ON_DATA_RANGE, null, msgs);
			if (newOnDataRange != null)
				msgs = ((InternalEObject)newOnDataRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.DATA_EXACT_CARDINALITY__ON_DATA_RANGE, null, msgs);
			msgs = basicSetOnDataRange(newOnDataRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_EXACT_CARDINALITY__ON_DATA_RANGE, newOnDataRange, newOnDataRange));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.DATA_EXACT_CARDINALITY__ON_PROPERTY:
				return basicSetOnProperty(null, msgs);
			case OWLPackage.DATA_EXACT_CARDINALITY__ON_DATA_RANGE:
