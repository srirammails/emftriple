 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.DifferentIndividualsImpl#getIndividuals <em>Individuals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DifferentIndividualsImpl extends AssertionImpl implements DifferentIndividuals {
	...
	public EList<Individual> getIndividuals() {
		if (individuals == null) {
			individuals = new EObjectContainmentEList<Individual>(Individual.class, this, OWLPackage.DIFFERENT_INDIVIDUALS__INDIVIDUALS);
		}
		return individuals;
	}
