 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.ReflexiveObjectPropertyImpl#getProperty <em>Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReflexiveObjectPropertyImpl extends ObjectPropertyAxiomImpl implements ReflexiveObjectProperty {
	...
	public NotificationChain basicSetProperty(ObjectPropertyExpression newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLPackage.REFLEXIVE_OBJECT_PROPERTY__PROPERTY, oldProperty, newProperty);
	...
	public void setProperty(ObjectPropertyExpression newProperty) {
		if (newProperty != property) {
			...
			if (property != null)
				msgs = ((InternalEObject)property).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLPackage.REFLEXIVE_OBJECT_PROPERTY__PROPERTY, null, msgs);
			if (newProperty != null)
				msgs = ((InternalEObject)newProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLPackage.REFLEXIVE_OBJECT_PROPERTY__PROPERTY, null, msgs);
			msgs = basicSetProperty(newProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.REFLEXIVE_OBJECT_PROPERTY__PROPERTY, newProperty, newProperty));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.REFLEXIVE_OBJECT_PROPERTY__PROPERTY:
