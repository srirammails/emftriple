 ...
 * <ul>
 *   <li>{@link com.emftriple.example.employee.impl.DegreeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DegreeImpl extends EObjectImpl implements Degree {
	...
	protected EClass eStaticClass() {
		return EmployeePackage.Literals.DEGREE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.DEGREE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmployeePackage.DEGREE__NAME:
				return getName();
		}
