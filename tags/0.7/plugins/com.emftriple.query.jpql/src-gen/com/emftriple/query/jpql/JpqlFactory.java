...
public interface JpqlFactory extends EFactory
{
   ...
   * @generated
   */
  JpqlFactory eINSTANCE = com.emftriple.query.jpql.impl.JpqlFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>JPQL Query</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>JPQL Query</em>'.
   * @generated
   */
