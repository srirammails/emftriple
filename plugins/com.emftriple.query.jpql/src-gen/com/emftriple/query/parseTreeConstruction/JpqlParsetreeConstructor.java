...
public class JpqlParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 3: return new JPQLQuery_Alternatives(this, this, 3, inst);
...
protected class QueryModule_DefaultQueryAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new JPQLQuery_Alternatives(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getJPQLQueryRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getQueryModuleAccess().getDefaultQueryJPQLQueryParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class NamedQuery_QueryAssignment_2 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getJPQLQueryRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getNamedQueryAccess().getQueryJPQLQueryParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
...
// SelectStatement | UpdateStatement | DeleteStatement
protected class JPQLQuery_Alternatives extends AlternativesToken {

	public JPQLQuery_Alternatives(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getJPQLQueryAccess().getAlternatives();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new JPQLQuery_SelectStatementParserRuleCall_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new JPQLQuery_UpdateStatementParserRuleCall_1(lastRuleCallOrigin, this, 1, inst);
			case 2: return new JPQLQuery_DeleteStatementParserRuleCall_2(lastRuleCallOrigin, this, 2, inst);
			default: return null;
		}	
	}
...
// SelectStatement
protected class JPQLQuery_SelectStatementParserRuleCall_0 extends RuleCallToken {
	
	public JPQLQuery_SelectStatementParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getJPQLQueryAccess().getSelectStatementParserRuleCall_0();
	}
...
// UpdateStatement
protected class JPQLQuery_UpdateStatementParserRuleCall_1 extends RuleCallToken {
	
	public JPQLQuery_UpdateStatementParserRuleCall_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getJPQLQueryAccess().getUpdateStatementParserRuleCall_1();
	}
...
// DeleteStatement
protected class JPQLQuery_DeleteStatementParserRuleCall_2 extends RuleCallToken {
	
	public JPQLQuery_DeleteStatementParserRuleCall_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getJPQLQueryAccess().getDeleteStatementParserRuleCall_2();
	}
