 ...
 * @generated
 */
public class MqlPackageImpl extends EPackageImpl implements MqlPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass mQueryEClass = null;
   ...
   * @see com.emftriple.query.mql.MqlPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MqlPackageImpl()
  {
    super(eNS_URI, MqlFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MqlPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MqlPackage init()
  {
    if (isInited) return (MqlPackage)EPackage.Registry.INSTANCE.getEPackage(MqlPackage.eNS_URI);

    // Obtain or create and register package
    MqlPackageImpl theMqlPackage = (MqlPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MqlPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MqlPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMqlPackage.createPackageContents();

    // Initialize created meta-data
    theMqlPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMqlPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MqlPackage.eNS_URI, theMqlPackage);
    return theMqlPackage;
  }
   ...
   * @generated
   */
  public EReference getMQuery_WhereClause()
  {
    return (EReference)mQueryEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public MqlFactory getMqlFactory()
  {
    return (MqlFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    mQueryEClass = createEClass(MQUERY);
    createEReference(mQueryEClass, MQUERY__WHERE_CLAUSE);
  ...
  public void initializePackageContents()
  {
    ...
    selectStatementEClass.getESuperTypes().add(this.getMQuery());
    selectStatementEClass.getESuperTypes().add(this.getExpressionTerm());
    updateStatementEClass.getESuperTypes().add(this.getMQuery());
    deleteStatementEClass.getESuperTypes().add(this.getMQuery());
    ...
    initEReference(getQueryModule_DefaultQuery(), this.getMQuery(), null, "defaultQuery", null, 0, 1, QueryModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNamedQuery_Query(), this.getMQuery(), null, "query", null, 0, 1, NamedQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(mQueryEClass, MQuery.class, "MQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMQuery_WhereClause(), this.getWhereClause(), null, "whereClause", null, 0, 1, MQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
