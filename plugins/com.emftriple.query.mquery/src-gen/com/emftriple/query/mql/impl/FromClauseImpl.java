 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.FromClauseImpl#getFromEntries <em>From Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromClauseImpl extends MinimalEObjectImpl.Container implements FromClause
{
  ...
  {
    return MqlPackage.Literals.FROM_CLAUSE;
  }
  ...
  public EList<FromEntry> getFromEntries()
  {
    if (fromEntries == null)
    {
      fromEntries = new EObjectContainmentEList<FromEntry>(FromEntry.class, this, MqlPackage.FROM_CLAUSE__FROM_ENTRIES);
    }
    return fromEntries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_CLAUSE__FROM_ENTRIES:
