 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.AnyExpressionImpl#getQuery <em>Query</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnyExpressionImpl extends ExpressionImpl implements AnyExpression
{
  ...
  {
    return MqlPackage.Literals.ANY_EXPRESSION;
  }
  ...
  public NotificationChain basicSetQuery(SelectStatement newQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.ANY_EXPRESSION__QUERY, oldQuery, newQuery);
  ...
  public void setQuery(SelectStatement newQuery)
  {
    if (newQuery != query)
    {
      ...
      if (query != null)
        msgs = ((InternalEObject)query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.ANY_EXPRESSION__QUERY, null, msgs);
      if (newQuery != null)
        msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.ANY_EXPRESSION__QUERY, null, msgs);
      msgs = basicSetQuery(newQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.ANY_EXPRESSION__QUERY, newQuery, newQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.ANY_EXPRESSION__QUERY:
