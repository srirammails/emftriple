 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.FromJoinImpl#isIsFetch <em>Is Fetch</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.FromJoinImpl#getPath <em>Path</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.FromJoinImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromJoinImpl extends MinimalEObjectImpl.Container implements FromJoin
{
  ...
  {
    return MqlPackage.Literals.FROM_JOIN;
  }
  ...
  public void setIsFetch(boolean newIsFetch)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_JOIN__IS_FETCH, oldIsFetch, isFetch));
  }
  ...
  public NotificationChain basicSetPath(AliasAttributeExpression newPath, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_JOIN__PATH, oldPath, newPath);
  ...
  public void setPath(AliasAttributeExpression newPath)
  {
    if (newPath != path)
    {
      ...
      if (path != null)
        msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_JOIN__PATH, null, msgs);
      if (newPath != null)
        msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_JOIN__PATH, null, msgs);
      msgs = basicSetPath(newPath, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_JOIN__PATH, newPath, newPath));
  }
  ...
  public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_JOIN__VARIABLE, oldVariable, newVariable);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    if (newVariable != variable)
    {
      NotificationChain msgs = null;
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_JOIN__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_JOIN__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_JOIN__VARIABLE, newVariable, newVariable));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_JOIN__PATH:
        return basicSetPath(null, msgs);
      case MqlPackage.FROM_JOIN__VARIABLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_JOIN__IS_FETCH:
        return isIsFetch();
      case MqlPackage.FROM_JOIN__PATH:
        return getPath();
      case MqlPackage.FROM_JOIN__VARIABLE:
