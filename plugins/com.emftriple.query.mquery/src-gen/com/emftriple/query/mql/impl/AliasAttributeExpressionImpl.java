 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.AliasAttributeExpressionImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link com.emftriple.query.mql.impl.AliasAttributeExpressionImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AliasAttributeExpressionImpl extends SelectExpressionImpl implements AliasAttributeExpression
{
  ...
  {
    return MqlPackage.Literals.ALIAS_ATTRIBUTE_EXPRESSION;
  }
    ...
    if (alias != null && alias.eIsProxy())
    {
      ...
      if (alias != oldAlias)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MqlPackage.ALIAS_ATTRIBUTE_EXPRESSION__ALIAS, oldAlias, alias));
      }
    }
    return alias;
  }
  ...
  public void setAlias(VariableDeclaration newAlias)
  {
    ...
    alias = newAlias;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.ALIAS_ATTRIBUTE_EXPRESSION__ALIAS, oldAlias, alias));
  }
  ...
  public EList<String> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EDataTypeEList<String>(String.class, this, MqlPackage.ALIAS_ATTRIBUTE_EXPRESSION__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MqlPackage.ALIAS_ATTRIBUTE_EXPRESSION__ALIAS:
        if (resolve) return getAlias();
        return basicGetAlias();
      case MqlPackage.ALIAS_ATTRIBUTE_EXPRESSION__ATTRIBUTES:
