 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.FromEntryImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromEntryImpl extends MinimalEObjectImpl.Container implements FromEntry
{
  ...
  {
    return MqlPackage.Literals.FROM_ENTRY;
  }
  ...
  public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_ENTRY__VARIABLE, oldVariable, newVariable);
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    if (newVariable != variable)
    {
      ...
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_ENTRY__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.FROM_ENTRY__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.FROM_ENTRY__VARIABLE, newVariable, newVariable));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.FROM_ENTRY__VARIABLE:
