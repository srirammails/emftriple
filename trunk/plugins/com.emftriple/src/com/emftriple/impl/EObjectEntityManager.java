...
public class EObjectEntityManager extends AbstractEntityManager implements EntityManager {
	 ...
	 * cannot be accessed
	 */
	@Override public <T> T getReference(Class<T> aClass, Object primarykey) {
		try {

			return (T) ObjectProxyFactory.createProxy(
					aClass, 
					mapping.getEClass(aClass),
					null, 
					EntityUtil.URI(primarykey), 
					dataSourceManager);
