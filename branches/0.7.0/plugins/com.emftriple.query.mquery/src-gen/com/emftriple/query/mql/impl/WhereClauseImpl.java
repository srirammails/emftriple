 ...
 * <ul>
 *   <li>{@link com.emftriple.query.mql.impl.WhereClauseImpl#getWhereEntry <em>Where Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhereClauseImpl extends MinimalEObjectImpl.Container implements WhereClause
{
  ...
  {
    return MqlPackage.Literals.WHERE_CLAUSE;
  }
  ...
  public NotificationChain basicSetWhereEntry(Expression newWhereEntry, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MqlPackage.WHERE_CLAUSE__WHERE_ENTRY, oldWhereEntry, newWhereEntry);
  ...
  public void setWhereEntry(Expression newWhereEntry)
  {
    if (newWhereEntry != whereEntry)
    {
      ...
      if (whereEntry != null)
        msgs = ((InternalEObject)whereEntry).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MqlPackage.WHERE_CLAUSE__WHERE_ENTRY, null, msgs);
      if (newWhereEntry != null)
        msgs = ((InternalEObject)newWhereEntry).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MqlPackage.WHERE_CLAUSE__WHERE_ENTRY, null, msgs);
      msgs = basicSetWhereEntry(newWhereEntry, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MqlPackage.WHERE_CLAUSE__WHERE_ENTRY, newWhereEntry, newWhereEntry));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MqlPackage.WHERE_CLAUSE__WHERE_ENTRY:
