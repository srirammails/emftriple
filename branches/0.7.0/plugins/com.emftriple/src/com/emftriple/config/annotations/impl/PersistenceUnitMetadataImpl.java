 ...
 * <ul>
 *   <li>{@link com.emftriple.config.annotations.impl.PersistenceUnitMetadataImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PersistenceUnitMetadataImpl extends MinimalEObjectImpl.Container implements PersistenceUnitMetadata {
	...
	protected EClass eStaticClass() {
		return OTMPackage.Literals.PERSISTENCE_UNIT_METADATA;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OTMPackage.PERSISTENCE_UNIT_METADATA__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OTMPackage.PERSISTENCE_UNIT_METADATA__DESCRIPTION:
